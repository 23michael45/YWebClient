	...
	<view class="mask" @tap="tapMask" :class="!value?'':'mask-show'" @touchmove.stop.prevent>
		...
		<block v-if="type=='input'">
			<view class="input-view" @tap.stop>
				<view class="title">{{mData.title}}</view>
				<view class="content" v-if="mData.isType!=1">
				...
				<view class="btn" v-if="mData.isType!=1">
					<view class="cancel" @tap="tapCancel" :style="{color:mData.cancelColor?mData.cancelColor:''}">{{mData.cancelText?mData.cancelText:'取消'}}</view>
				...
				<view class="btn" v-if="mData.isType==1">
					<view class="cancel" @tap="createCommodity(1)" :style="{color:mData.cancelColor?mData.cancelColor:''}">{{mData.cancelText?mData.cancelText:'图片'}}</view>
					<view class="confirm" @tap="createCommodity(0)" :style="{color:mData.confirmColor?mData.confirmColor:''}">{{mData.confirmText?mData.confirmText:'视频'}}</view>
				</view>
			</view>
		</block>
